...
class SiswaSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('siswa')->insert([
            ...
            [
            'nis' => '12345692',
            'nama_siswa' => 'Tono Hartono',
            'gender' => 'Laki-laki',
            'kelas_id' => 3,
            'email' => 'tono.hartono@example.com',
            'password' => bcrypt('password123'),
            'avatar' => 'default_avatar.png',
            'role' => 3,
            'is_active' => 1,
            ...
            [
            'nis' => '12345701',
            'nama_siswa' => 'Joni Saputra',
            'gender' => 'Laki-laki',
            'kelas_id' => 3,
            'email' => 'joni.saputra@example.com',
            'password' => bcrypt('password123'),
            'avatar' => 'default_avatar.png',
            'role' => 3,
            'is_active' => 1,
            ...
            [
            'nis' => '12345704',
            'nama_siswa' => 'Mira Puspita',
            'gender' => 'Perempuan',
            'kelas_id' => 1,
            'email' => 'mira.puspita@example.com',
            'password' => bcrypt('password123'),
            'avatar' => 'default_avatar.png',
            'role' => 3,
            'is_active' => 1,
            ...
            [
            'nis' => '12345707',
            'nama_siswa' => 'Putu Sari',
            'gender' => 'Perempuan',
            'kelas_id' => 2,
            'email' => 'putu.sari@example.com',
            'password' => bcrypt('password123'),
            'avatar' => 'default_avatar.png',
            'role' => 3,
            'is_active' => 1,
