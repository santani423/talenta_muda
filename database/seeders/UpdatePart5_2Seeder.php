...
class UpdatePart5_2Seeder extends Seeder
{
    /**
    ...
    {
        $kuisoner = array(
            array("val0" => "Sulit bagi saya untuk melihat seseorang yang sedang menderita", "val1" => "Crudelia", "val2" => "negatif"),
            ...
            array("val0" => "Orang yang cerdas selalu tahu kapan, bagaimana, dan kepada siapa ia harus berkata-kata untuk menentukan nasib orang yang menyinggung dia", "val1" => "Frustalia", "val2" => "positif"),
            array("val0" => "Kebanyakan orang pada dasarnya baik dan murah hati", "val1" => "Machiavellianism", "val2" => "negatif"),
            array("val0" => "Saya tidak keberatan untuk berbagi panggung dengan orang lain", "val1" => "Narcissism", "val2" => "negatif"),
            array("val0" => "Pembalasan harus cepat dan kejam", "val1" => "Psychopathy", "val2" => "positif"),
            ...
            array("val0" => "Pada prinsipnya setiap orang berhak diperlakukan sama", "val1" => "Narcissism", "val2" => "negatif"),
            array("val0" => "Saya akan mengatakan apapun untuk mendapatkan apa yang saya inginkan", "val1" => "Psychopathy", "val2" => "positif"),
            array("val0" => "Menyakiti orang akan membuat saya merasa sangat tidak nyaman", "val1" => "Sadism", "val2" => "negatif"),
            ...
            array("val0" => "Saya tidak terlalu peduli untuk memiliki kontrol atas orang lain.", "val1" => "Machiavellianism", "val2" => "negatif"),
            array("val0" => "Orang yang mencari masalah dengan saya selalu menyesalinya.", "val1" => "Psychopathy", "val2" => "positif"),
            array("val0" => "Banyak hal tidak dapat berjalan sesuai dengan keinginan saya", "val1" => "Psychological Entitlement", "val2" => "negatif"),
            ...
            array("val0" => "Kenapa saya harus peduli dengan orang lain, ketika tidak ada orang yang peduli dengan saya?", "val1" => "Crudelia", "val2" => "positif"),
            array("val0" => "Saya tidak akan berbuat curang walaupun hanya terdapat sedikit kemungkinan untuk tertangkap", "val1" => "Machiavellianism", "val2" => "negatif"),
            array("val0" => "Sebagian besar orang, entah bagaimana, adalah orang-orang yang gagal", "val1" => "Narcissism", "val2" => "positif"),
            array("val0" => "Saya tidak terlalu suka untuk memanipulasi perasaan orang lain", "val1" => "Psychopathy", "val2" => "negatif"),
            array("val0" => "Saya tidak bisa membayangkan bagaimana bertindak jahat terhadap orang lain bisa begitu menyenangkan", "val1" => "Sadism", "val2" => "negatif"),
            array("val0" => "Saya mau menjadi sukarelawan untuk orang yang membutuhkan", "val1" => "Crudelia", "val2" => "negatif"),
            ...
            array("val0" => "Pembalasan dendam tidak memberikan kepuasan", "val1" => "Frustalia", "val2" => "negatif"),
            array("val0" => "Sebagian besar orang layak dihormati", "val1" => "Machiavellianism", "val2" => "negatif"),
            array("val0" => "Saya hampir tidak tahan jika orang lain menjadi pusat perhatian", "val1" => "Narcissism", "val2" => "positif"),
            array("val0" => "Saya selalu berusaha untuk tidak menyakiti orang lain dalam mengejar tujuan-tujuan saya", "val1" => "Psychopathy", "val2" => "negatif"),
            ...
            array("val0" => "Melakukan perbuatan baik membawa kegembiraan di hati", "val1" => "Crudelia", "val2" => "negatif"),
            ...
            array("val0" => "Melihat kegagalan saingan saya, tidak membuat saya merasa senang", "val1" => "Narcissism", "val2" => "negatif"),
            ...
            array("val0" => "Saya menghindari mempermalukan orang lain", "val1" => "Sadism", "val2" => "negatif"),
            ...
            array("val0" => "Saya tidak akan mengejar apa yang saya inginkan jika ini menyebabkan masalah bagi orang lain", "val1" => "Self Centeredness", "val2" => "negatif"),
            ...
            array("val0" => "Saya tidak haus kekuasaan", "val1" => "Narcissism", "val2" => "negatif"),
            ...
            array("val0" => "Saya cenderung untuk memaafkan perlakuan-perlakuan buruk yang pernah saya alami", "val1" => "Psychological Entitlement", "val2" => "negatif"),
            array("val0" => "Saya akan sangat menyesal jika saya menyakiti orang lain", "val1" => "Sadism", "val2" => "negatif"),
            ...
            array("val0" => "Saya merasa bersalah jika saya membuat orang lain kecewa", "val1" => "Self Centeredness", "val2" => "negatif"),
            array("val0" => "Kadang dibutuhkan sedikit pengorbanan dari diri saya untuk bisa menolong orang lain yang membutuhkan", "val1" => "Spitefulness", "val2" => "negatif"),
            array("val0" => "Membuat orang lain merasa tidak nyaman dengan keadaan dirinya tidak membuat saya merasa lebih baik", "val1" => "Sadism", "val2" => "negatif"),

        );
        $kode = 'part5_2';
        $data = DetailKuisoner::where('kode', $kode)->get();
        foreach ($data as $number => $answer) {

            $kuisoner[$number]['val0'] = $answer->soal;
            $kuisoner[$number]['val1'] = $answer->item;
            DetailKuisoner::where('id', $answer->id)->update([
                'kode' => $kode,
                'soal' => $kuisoner[$number]['val0'],
                'item' => $kuisoner[$number]['val2'],
                // 'jenis_jawaban_kuesioner_id' => 1,
                // 'created_at' => now(),
                // 'updated_at' => now()
            ]);
            $sekala = Sekala::where('sekala', $kuisoner[$number]['val1'])->first();
            DetailKuisonerSekala::where('detail_kuisoner_id', $answer->id)->update([
                'kode_sekala' => $sekala ? $sekala->kode : $kuisoner[$number]['val1'],
                'created_at' => now(),
                'updated_at' => now()
            ]);
        }
