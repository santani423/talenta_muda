                                        ...
                                        <div class="widget shadow p-2">
                                            <div>
                                                @php
                                                    ...
                                                    $soal_hidden = '';
                                                @endphp
                                                @foreach ($ujian->detailKuisoner as $soal)
                                            ...
                                            <input type="hidden" value="{{ $ujian->detailKuisoner->count() }}" id="totalOfQuestion"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2 footer-question-number-wrapper text-center">
                                            <div>
                                                ...
                                                <span>Dari <b>{{ $ujian->detailKuisoner->count() }}</b></span>
                                            </div>
                                            <div>
                                                Nomor Soal
                                            </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($results as $s)
                                                                ...
                                                                <tr class="text-center">
                                                                    ...
                                                                    <td>
                                                                        <a href="{{ url("/guru/ujian_kuesioner/" . $s['kode_ujian'] . "/" . $s['siswa_id']) }}" class="btn btn-info"><span data-feather="eye"></span></a> 
                                                                    </td>
                                                                </tr>
