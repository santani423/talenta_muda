                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endif
                                                @if ($u->jenis == 2)
                                                <a href="{{ url('/guru/ujian_kuesioner/' . $u->kode) }}" class="btn btn-primary btn-sm">
                                                    <span data-feather="eye"></span>
                                                </a>
                                                @endif
                                                @if ($u->jenis == 3)
                                                <a href="{{ url('/guru/ujian_visual/' . $u->kode) }}" class="btn btn-primary btn-sm">
                                                    <span data-feather="eye"></span>
                                                </a>
                                                @endif
                                                @if ($u->jenis == 0)
                                                <a href="{{ url('/guru/ujian/' . $u->kode.'/edit') }}" class="btn btn-success btn-sm">
                                                    <span data-feather="edit"></span>
                                                </a>
                                                @endif

                                                @if ($u->jenis == 1)
                                                <a href="{{ url('/guru/ujian_essay/' . $u->kode.'/edit') }}" class="btn btn-success btn-sm">
                                                    <span data-feather="edit"></span>
                                                </a>
                                                @endif
                                                @if ($u->jenis == 2)
                                                <a href="{{ url('/guru/ujian_kuesioner/' . $u->kode.'/edit_kuesioner') }}" class="btn btn-success btn-sm">
                                                    <span data-feather="edit"></span>
                                                </a>
                                                @endif
                                                @if ($u->jenis == 3)
                                                <a href="{{ url('/guru/ujian_visual/' . $u->kode.'/edit_visual') }}" class="btn btn-success btn-sm">
                                                    <span data-feather="edit"></span>
                                                </a>
                                                @endif
